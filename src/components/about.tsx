...
export default function About() {
  return (
    <section className={`bg-[#E1F1F0] py-16 px-8 ${poppins.className}`}>
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center ml-[150px]"> 
        <div>
          <h2 className="text-[#88B520] font-bold text-sm" style={{fontSize: '18px'}}>ABOUT US</h2>
          ...
          <button className="mt-6 bg-red-500 text-white px-6 py-3 rounded-full font-bold">
            Start your journey today
          </button>
          <span className={`ml-4 text-red-500 font-bold ${shadowsIntoLight.className}`} style={{fontSize:'37px'}}>it's free!</span>
        </div>

        <div className="relative flex justify-center lg:ml-16"> 
          <Image src={phoneMockup} alt="Phone Mockup" width={500} height={500} />
        </div>
      </div>
    </section>
  );
